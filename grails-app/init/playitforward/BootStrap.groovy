...
class BootStrap
{
    def init = { servletContext ->
        ...
        new Event(organizer: cfb, name: "GP New Jersey Standard", type: gp, startDate: new Date(117, 2, 11), endDate: new Date(117, 2, 12)).save();
        ...
        new Event(organizer: cfb, name: "GP Las Vegas Legacy", type: gp, startDate: new Date(117, 5, 15), endDate: new Date(117, 5, 16)).save();
        new Event(organizer: cfb, name: "GP Las Vegas Limited", type: gp, startDate: new Date(117, 5, 16), endDate: new Date(117, 5, 17)).save();
        new Event(organizer: cfb, name: "GP Las Vegas Modern", type: gp, startDate: new Date(117, 5, 17), endDate: new Date(117, 5, 18)).save();
        ...
        new Event(organizer: cfb, name: "GP New Jersey Limited", type: gp, startDate: new Date(117, 11, 16), endDate: new Date(117, 11, 17)).save();
